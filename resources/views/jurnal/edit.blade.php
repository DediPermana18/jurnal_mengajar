        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-warning text-dark py-3">
                    <h5 class="mb-0 fw-bold"><i class="bi bi-pencil-square"></i> Edit Jurnal Mengajar</h5>
                </div>
                    ...
                    <form action="{{ route('jurnal.update', $jurnal->id_jurnal ?? $jurnal->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $jurnal->tanggal) }}" required>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="materi" class="form-control @error('materi') is-invalid @enderror" value="{{ old('materi', $jurnal->materi) }}" placeholder="Masukkan materi pembelajaran" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Keterangan / Deskripsi Kegiatan</label>
                            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="3" placeholder="Deskripsi kegiatan atau catatan khusus">{{ old('keterangan', $jurnal->keterangan) }}</textarea>
                        </div>

                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label fw-bold">Jumlah Siswa Hadir <span class="text-danger">*</span></label>
                                <input type="number" name="jumlah_siswa_hadir" class="form-control @error('jumlah_siswa_hadir') is-invalid @enderror" value="{{ old('jumlah_siswa_hadir', $jurnal->jumlah_siswa_hadir) }}" min="0" required>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="tahun_ajaran" class="form-control @error('tahun_ajaran') is-invalid @enderror" value="{{ old('tahun_ajaran', $jurnal->tahun_ajaran) }}" required>
                            </div>
                        </div>
