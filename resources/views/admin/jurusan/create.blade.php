...
@section('title', 'Tambah Jurusan - WebJournal Management System')
...
<div class="container-fluid px-0" style="max-width: 760px;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-1" style="font-size: 1.65rem; letter-spacing: -0.02em;">Tambah Data Jurusan</h3>
            <p class="text-muted small mb-0">Tambahkan program keahlian / kompetensi keahlian baru.</p>
        </div>
