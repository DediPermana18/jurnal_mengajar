...
<div class="container-fluid px-0">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-3 md:mb-4">
        ...
        <div>
            <div class="stat-card-custom p-3 md:p-4 h-100">
                <div class="stat-card-title text-xs md:text-sm truncate mb-1 md:mb-2" title="Kendala Berhasil Diatasi">Bug Teratasi</div>
                <div class="stat-number-large text-2xl md:text-4xl text-success mb-1">{{ number_format($selesaiCount) }}</div>
                <div class="stat-card-label text-xs md:text-sm truncate" title="Kendala berstatus selesai">Kendala diatasi {{ $kendala->count() > 0 ? 'dari total '.number_format($kendala->count()) : '' }}</div>
            </div>
        </div>
        <div>
            <div class="stat-card-custom p-3 md:p-4 h-100">
