...
@section('title', 'Edit Mata Pelajaran - WebJournal Management System')
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="text-muted mb-0" style="font-size: 0.875rem;">
                    Perbarui data mata pelajaran <strong>{{ $mapel->nama_mapel }}</strong>.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 rounded-4 shadow-sm bg-white overflow-hidden" style="max-width: 800px;">
        <div class="card-header bg-white border-0 pt-4 pb-3 px-4">
            <div class="d-flex align-items-center gap-2">
                <div class="rounded-2 d-flex align-items-center justify-content-center bg-warning-subtle text-warning-emphasis"
                     style="width: 36px; height: 36px;">
                    <i class="bi bi-pencil-square fs-5"></i>
                </div>
                <h5 class="fw-bold mb-0 text-dark">Form Edit Mata Pelajaran</h5>
            </div>
        </div>

        <form method="POST" action="{{ route('mapel.update', $mapel->id) }}" id="formEditMapel">
            @csrf
            @method('PUT')
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="kode_mapel" class="form-control rounded-3 py-2"
                               value="{{ old('kode_mapel', $mapel->kode_mapel) }}" required autocomplete="off">
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="jurusan_id" class="form-select rounded-3 py-2" id="jurusanSelect" disabled>
                            ...
                            <option value="" id="optPilihJurusan" style="display: none;" disabled {{ old('jurusan_id', $mapel->jurusan_id) ? '' : 'selected' }}>-- Pilih Jurusan Spesifik --</option>
