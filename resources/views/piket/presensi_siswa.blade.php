...
@section('title', 'Presensi Siswa - WebJournal')
...
<div class="container-fluid px-0">
    <div class="mb-4">
        ...
        <p class="text-muted mb-0" style="font-size: 0.9rem;">
            Catat dan pantau kehadiran siswa — {{ now()->translatedFormat('l, d F Y') }}
        </p>
    </div>

    <div class="card border-0 shadow-sm rounded-4 p-5 text-center">
        <i class="bi bi-people-fill text-success mb-3" style="font-size: 3rem;"></i>
        <h5 class="fw-bold text-dark mb-2">Halaman Presensi Siswa</h5>
        <p class="text-muted">Fitur input presensi siswa akan segera tersedia di sini.</p>
